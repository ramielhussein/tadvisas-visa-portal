  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-6 z-50 animate-fade-in">
        <button
          onClick={handleWhatsAppClick}
          className="group flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-full shadow-xl hover:shadow-2xl transition-all transform hover:scale-110"
        >
          <svg
            className="w-6 h-6"
            fill="currentColor"
