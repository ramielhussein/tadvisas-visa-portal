...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | TADMAIDS</title>
        <meta name="description" content="TADMAIDS Privacy Policy - How we collect, use, store, and protect your personal information." />
      </Helmet>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-foreground">
          <section>
            ...
            <p>TADMAIDS Domestic Workers Services Center LLC ("TADMAIDS", "we", "our", or "us") respects your privacy and is committed to protecting your personal information.</p>
            <p>This Privacy Policy explains how we collect, use, store, and protect your information when you interact with our services, including:</p>
          ...
          <section>
            ...
            <p>For domestic worker recruitment or visa services, we may collect:</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <p>When a payment is made for services, we may collect limited information such as:</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <p>TADMAIDS does not store, process, or retain full payment card details such as credit card numbers, CVV codes, or card expiration dates.</p>
            <p>All electronic payments are processed securely through licensed third-party payment providers, and any card information entered is handled directly by those providers in accordance with their security standards.</p>
          </section>
          ...
          <section>
            ...
            <p>Your information is used for legitimate business purposes including:</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <p className="mt-3">We may also use your contact information to send:</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <section>
            ...
            <p>All partners are expected to handle personal information responsibly and only for service delivery purposes.</p>
            <p className="font-medium">TADMAIDS does not sell or rent personal data to third parties.</p>
          </section>
          ...
          <section>
            ...
            <p>TADMAIDS takes reasonable administrative and technical measures to protect personal information including:</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <p>While we implement strong safeguards, no system can guarantee absolute security.</p>
          </section>
          ...
          <section>
            ...
            <p>Visa-related records may be retained for the duration required by UAE authorities.</p>
          </section>
          ...
          <section>
            ...
            <p>Some information may need to be retained to comply with UAE regulatory requirements.</p>
          </section>
          ...
          <section>
            ...
            <p>TADMAIDS may update this Privacy Policy from time to time to reflect:</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>Changes in legal requirements</li>
              <li>Updates to our services</li>
              <li>Improvements in data protection practices</li>
            </ul>
            <p>Any updates will be published on our website.</p>
          </section>
