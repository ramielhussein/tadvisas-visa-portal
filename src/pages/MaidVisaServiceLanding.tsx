  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-12 md:py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-gray-900 via-primary to-gray-900" />
        {/* Decorative elements */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <p className="text-amber-400 text-sm font-semibold uppercase tracking-widest mb-2">Why Families Trust Us</p>
            <h3 className="text-2xl md:text-3xl font-bold text-white">Licensed. Trusted. Proven.</h3>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
            {trustBadges.map((badge, index) => (
              <div 
                key={index} 
                className="group relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 md:p-6 hover:bg-white/20 hover:border-amber-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-amber-400/20"
              >
                {/* Glow effect on hover */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-amber-400/0 to-primary/0 group-hover:from-amber-400/10 group-hover:to-primary/10 transition-all duration-500" />
                
                <div className="relative flex flex-col items-center text-center">
                  {/* Icon container */}
                  <div className="mb-4 p-3 rounded-xl bg-gradient-to-br from-amber-400/20 to-amber-600/20 border border-amber-400/30 group-hover:from-amber-400/30 group-hover:to-amber-600/30 group-hover:border-amber-400/50 transition-all duration-300">
                    <div className="text-amber-400 group-hover:text-amber-300 transition-colors duration-300">
                      {badge.icon}
                    </div>
                  </div>
                  <p className="text-sm md:text-base font-semibold text-white/90 group-hover:text-white transition-colors duration-300 leading-tight">
                    {badge.text}
                  </p>
                </div>
              </div>
          ...
          <div className="mt-10 flex justify-center">
            <div className="flex items-center gap-3 px-6 py-3 bg-white/5 backdrop-blur-sm rounded-full border border-white/10">
              ...
              <span className="text-white/80 text-sm font-medium">Rated 4.9/5 by 2,000+ UAE Families</span>
            </div>
          </div>
        </div>
      </section>
