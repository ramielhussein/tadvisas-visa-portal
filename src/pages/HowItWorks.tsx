...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      details: ["Government submissions (pre approval, visa, vpa, EID, medical)", "Medical appointments, we will chauffer her back and for.", "Emirates ID processing, will drop your worker and return her safe and sound.", "Status updates"]
    },
    {
      icon: FileCheck,
