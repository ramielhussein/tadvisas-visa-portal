...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      details: ["Government submissions (pre approval, visa, vpa, EID, medical)", "Medical appointments, we will chauffer her back and for.", "Emirates ID processing", "Status updates"]
    },
    {
      icon: FileCheck,
