        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg mb-16 border-2 border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Cancellation Service Add-on */}
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Cancellation Service</h3>
                </div>
                <p className="text-gray-600 mb-4">Complete visa cancellation when needed</p>
                <div className="text-2xl font-bold text-primary mb-2">300 AED</div>
                <p className="text-sm text-gray-500">When required</p>
              </div>

              {/* End of Service Benefits Add-on */}
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border border-yellow-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">End of Service Benefits</h3>
                  <span className="bg-yellow-500 text-black px-3 py-1 rounded-full text-sm font-bold">Premium</span>
                </div>
                <p className="text-gray-600 mb-4">EOSB coverage for your helper</p>
                <div className="text-2xl font-bold text-primary mb-2">Included</div>
                <p className="text-sm text-gray-500">In TADVISA++ only</p>
              </div>

              {/* Return Home Ticket Add-on */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Return Home Ticket</h3>
                </div>
                <p className="text-gray-600 mb-4">Flight ticket at contract end</p>
                <div className="text-2xl font-bold text-primary mb-2">Market Rate</div>
                <p className="text-sm text-gray-500">Or included in TADVISA++</p>
              </div>

              {/* Absconding Support Add-on */}
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Absconding/Fines Support</h3>
                  <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-bold">Support</span>
                </div>
                <p className="text-gray-600 mb-4">Help with absconding cases & fine removal</p>
                <div className="text-2xl font-bold text-primary mb-2">FREE</div>
                <p className="text-sm text-gray-500">Consultation & support</p>
              </div>
            </div>
          </div>
